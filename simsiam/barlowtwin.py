...
def main_worker(gpu, ngpus_per_node, args):
    ...
    import barlowtwin_builder
    model = barlowtwin_builder.BarlowTwin(
        baseModel,
        args.dim, args.projector, args.lambd)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if not args.multiprocessing_distributed or (args.multiprocessing_distributed
            ...
            }, is_best=False, filename='checkpoints/barlowtwin/checkpoint_{:04d}.pth.tar'.format(epoch))
